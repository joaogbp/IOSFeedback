...
public class ManagerFeedback {
    ...
    static private var soundID_Impact: SystemSoundID = 1103 // Pin // swiftlint:disable identifier_name
    static private var soundID_Impact_Loud: SystemSoundID = 1057 // swiftlint:disable identifier_name
    static private var soundID_Selector: SystemSoundID = 1105 // swiftlint:disable identifier_name
    
    static private var soundID_Delete: SystemSoundID = 1003 // swiftlint:disable identifier_name
    static private var soundID_Skip: SystemSoundID = 1003 // swiftlint:disable identifier_name
    
    static private var soundID_A: SystemSoundID = 1109 // X // swiftlint:disable identifier_name
    static private var soundIDHMM_0: SystemSoundID = 1050 // // swiftlint:disable identifier_name
    static private var soundIDHMM_1: SystemSoundID = 1051 // HAPTIC // swiftlint:disable identifier_name
    static private var soundIDHMM_2: SystemSoundID = 1052 // HAPTIC // swiftlint:disable identifier_name
    
    static private var soundID_Type: SystemSoundID = 1306 // Type Light // swiftlint:disable identifier_name
